<<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
        <title>Current Case Repository</title>
        ...
        <h3>
            <table width="100%" align="center">
                <tr>
                    ...
                    <th>DEFENDING CLIENT</th>
                    <th>OPPOSING LAWYER</th>
                    <th>OPPOSING CLIENT</th>
                    <th>CASE VERDICT</th>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row['HearingDate'] . "</td>";
                        echo "<td>" . $row['DefendingLawyer'] . "</td>";
                        echo "<td>" . $row['Defendingwitnesses'] . "</td>";
                        echo "<td>" . $row['OpposingLawyer'] . "</td>";
                        echo "<td>" . $row['Opposingwitnesses'] . "</td>";
